...
pub mod thorium {
    ...
    pub use thorium::models::{
        Attachment, BulkReactionResponse, CarvedOriginPy, Comment, CommitishKinds, EntityKinds,
        FileListOpts, GenericJob, GenericJobArgs, GenericJobOpts, HandleJobResponse,
        JobHandleStatus, OriginPy, Output, OutputMap, Reaction, ReactionCache, ReactionCreation,
        ReactionRequest, ReactionStatus, RepoDependency, RepoDependencyRequest, ResultGetParams,
        SampleListLine, SamplePy, SubmissionChunkPy, TagCounts, TagKeyCounts,
    };
}
